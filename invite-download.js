parcelRequire = function(e, r, n, t) {
    ...
    "O+B/": [function(require, module, exports) {
        var define;
        var global = arguments[3];
        var t, e = arguments[3]; !
        function(e, n) {
            "object" == typeof exports && "object" == typeof module ? module.exports = n() : "function" == typeof t && t.amd ? t([], n) : "object" == typeof exports ? exports.ClipboardJS = n() : e.ClipboardJS = n()
        } (this,
        function() {
            return function(t) {
                var e = {};
                ...
                r = [t, n(7)],
                void 0 === (i = "function" == typeof(o = a) ? o.apply(e, r) : o) || (t.exports = i)
            },
            function(t, e, n) {
                var o = n(6),
                r = n(5);
            ...
            function(t, e, n) {
                ...
                t.exports = function(t, e, n, o, i) {
                    return "function" == typeof t.addEventListener ? r.apply(null, arguments) : "function" == typeof n ? r.bind(null, document).apply(null, arguments) : ("string" == typeof t && (t = document.querySelectorAll(t)), Array.prototype.map.call(t,
                    function(t) {
                        return r(t, e, n, o, i)
                    }))
                }
    ...
    "Focm": [function(require, module, exports) {
        ...
        var o = i(location.href).code || "";
        function c(e) {
            if (!o) return ! 1;
            var n = document.getElementById("copy-btn");
            n.onclick = null,
            r("#copy-btn", o, e);
            var t = document.querySelector(".fixed");
            t.style.zIndex = "1",
            t.style.opacity = "1",
            setTimeout(function() {
                t.style.zIndex = "-1",
        ...
        function i(e) {
            return "string" != typeof e ? {}: (e.match(/\?/) && (e = e.slice(e.match(/\?/).index + 1)), decodeURIComponent(e).split("&").map(function(e) {
                var n = e.split("=");
                return {
                    key: n[0],
                    value: n[1] || ""
                ...
                var t = n.key,
                o = n.value;
                return void 0 === e[t] ? e[t] = o: (e[t] = Array.isArray(e[t]) ? e[t] : [e[t]], e[t].push(o)),
                e
            },
            {}))
        } !
        function(e, n) {
            ...
            i = function() {
                var e = t.clientWidth < 320 ? 320 : t.clientWidth;
                e && (t.style.fontSize = e / 375 * 20 + "px")
            };
            n.addEventListener(r, i, !1),
            e.addEventListener("DOMContentLoaded", i, !1),
            e.getElementById("code").innerText = "邀请码：" + o,
            e.getElementById("copy-btn").onclick = c
        } (document, window);
    },
    {
        "clipboard": "O+B/"
...
{},
["Focm"], null)
//# sourceMappingURL=invite-download.79eb8f49.map